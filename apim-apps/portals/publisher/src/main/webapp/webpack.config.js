    ...
    const config = {
        ...
        */
        devServer: {
            ...
            proxy: {
                '/services/': {
                    target: 'https://localhost:9448/publisher',
                    secure: false,
                },
                '/api/am/publisher/v3/swagger.yaml': {
                    target: isTestBuild ? 'https://raw.githubusercontent.com/wso2/carbon-apimgt/master/components/apimgt/org.wso2.carbon.apimgt.rest.api.publisher.v1/src/main/resources/publisher-api.yaml' : 'https://localhost:9448/api/am/publisher/v3/swagger.yaml',
                    secure: false,
                    changeOrigin: true,
                ...
                '/api/am': {
                    target: isTestBuild ? 'http://localhost:4010' : 'https://localhost:9448',
                    // pathRewrite: { '^/api/am/publisher/v3/': '' },
                    secure: false,
                },
                '/publisher/services': {
                    target: 'https://localhost:9448',
                    secure: false,
                },
                '/publisher': {
