...
const getSampleOpenAPI = (defaultSubscriptionPolicy) => ({
    ...
    'x-wso2-production-endpoints': {
        urls: ['https://localhost:9448/am/sample/pizzashack/v1/api/'],
        type: 'http',
    },
...
const getSampleAPIData = (defaultAdvancePolicy, defaultSubscriptionPolicy) => {
    return {
        ...
        endpointConfig: {
            endpoint_type: 'http',
            sandbox_endpoints: {
                url: 'https://localhost:9448/am/sample/pizzashack/v1/api/',
            },
...
const getSampleServiceMeta = () => ({
    ...
    serviceUrl: 'https://localhost:9448/am/sample/pizzashack/v1/api/',
    definitionType: 'OAS3',
});
